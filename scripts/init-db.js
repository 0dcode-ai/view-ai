...
const tableSql = [
  ...
  `CREATE TABLE IF NOT EXISTS "ResumeProfile" (
    ...
    "candidatePrepJson" TEXT NOT NULL DEFAULT '{}',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
  )`,
  ...
  `CREATE TABLE IF NOT EXISTS "TechnicalArticle" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "title" TEXT NOT NULL,
    "topic" TEXT,
    "tagsJson" TEXT NOT NULL DEFAULT '[]',
  ...
  `CREATE TABLE IF NOT EXISTS "TechnicalArticleAsset" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "articleId" INTEGER,
    "url" TEXT NOT NULL,
    ...
    "altText" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "TechnicalArticleAsset_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "TechnicalArticle" ("id") ON DELETE CASCADE ON UPDATE CASCADE
  )`,
  `CREATE TABLE IF NOT EXISTS "StartupIdea" (
    ...
    "aiAgentFlow" TEXT NOT NULL DEFAULT '',
    "dataSignals" TEXT NOT NULL DEFAULT '',
  ...
  `CREATE TABLE IF NOT EXISTS "GithubRepositorySnapshot" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    ...
    "window" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "GithubRepositorySnapshot_repositoryId_fkey" FOREIGN KEY ("repositoryId") REFERENCES "GithubRepository" ("id") ON DELETE CASCADE ON UPDATE CASCADE
  )`,
];
...
const columnSql = {
  ...
  ResumeProfile: [
    ["candidatePrepJson", `"candidatePrepJson" TEXT NOT NULL DEFAULT '{}'`],
  ],
};
...
const indexSql = [
  ...
  `CREATE INDEX IF NOT EXISTS "TechnicalArticle_topic_idx" ON "TechnicalArticle"("topic")`,
  `CREATE INDEX IF NOT EXISTS "TechnicalArticle_status_idx" ON "TechnicalArticle"("status")`,
  `CREATE INDEX IF NOT EXISTS "TechnicalArticle_updatedAt_idx" ON "TechnicalArticle"("updatedAt")`,
  `CREATE INDEX IF NOT EXISTS "TechnicalArticleAsset_articleId_idx" ON "TechnicalArticleAsset"("articleId")`,
  `CREATE INDEX IF NOT EXISTS "TechnicalArticleAsset_mimeType_idx" ON "TechnicalArticleAsset"("mimeType")`,
  `CREATE INDEX IF NOT EXISTS "StartupIdea_status_idx" ON "StartupIdea"("status")`,
  `CREATE INDEX IF NOT EXISTS "StartupIdea_updatedAt_idx" ON "StartupIdea"("updatedAt")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "GithubRepository_githubId_key" ON "GithubRepository"("githubId")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "GithubRepository_fullName_key" ON "GithubRepository"("fullName")`,
  `CREATE INDEX IF NOT EXISTS "GithubRepository_fullName_idx" ON "GithubRepository"("fullName")`,
  `CREATE INDEX IF NOT EXISTS "GithubRepository_language_idx" ON "GithubRepository"("language")`,
  `CREATE INDEX IF NOT EXISTS "GithubRepository_isFavorite_idx" ON "GithubRepository"("isFavorite")`,
  `CREATE INDEX IF NOT EXISTS "GithubRepository_pushedAt_idx" ON "GithubRepository"("pushedAt")`,
  `CREATE INDEX IF NOT EXISTS "GithubRepository_stars_idx" ON "GithubRepository"("stars")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "GithubRepositorySnapshot_repositoryId_snapshotDate_key" ON "GithubRepositorySnapshot"("repositoryId", "snapshotDate")`,
  `CREATE INDEX IF NOT EXISTS "GithubRepositorySnapshot_snapshotDate_idx" ON "GithubRepositorySnapshot"("snapshotDate")`,
  `CREATE INDEX IF NOT EXISTS "GithubRepositorySnapshot_score_idx" ON "GithubRepositorySnapshot"("score")`,
  `CREATE INDEX IF NOT EXISTS "GithubRepositorySnapshot_repositoryId_idx" ON "GithubRepositorySnapshot"("repositoryId")`,
];
